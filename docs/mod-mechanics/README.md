...
12. [Maps](maps.md): filled-map pixel updates, player marker aliasing, Atlas
   Projector discovery, held/placed projector rendering, and discovery-powered
   Atlas rewards.
...
| Filled maps and Atlas Projectors | Filled-map marker aliasing implemented; Atlas Projector torus, held projection, discovery-powered effects, and Mastered Atlas linked travel use shared player-driven canonical discovery | [maps.md](maps.md) |
