...
- [AI social alias follow-ups](ai-social-alias-followups.md): audited
  tameable, social follow, temptation, and short-range AI behaviors that still
  need actor-local alias handling after the owner-follow teleport fix.
